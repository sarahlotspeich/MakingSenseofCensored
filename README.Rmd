...
There is no simple implementation of Bayesian Methods for censored covariates that we are aware of. Bayesian specific software, such as winBUGS and Stan, may be useful. 
